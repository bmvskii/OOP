...
DECLARE_OOP_TEST ( test_calculate_total_components_of_menu )
{
	...
	assert( equalDoubles(totalComponents.getProteins(), 44.5)); // 200 / 100 * 3.2 + 300 / 100 * 12.7  = 44.5
	assert( equalDoubles(totalComponents.getFat(), 41.7) ); // 200 / 100 * 3.6 + 300 / 100 * 11.5  = 41.7
	assert(equalDoubles(totalComponents.getCarbo(), 11.7) ); // 200 / 100 * 4.8 + 300 / 100 * 0.7   = 11.7
}
